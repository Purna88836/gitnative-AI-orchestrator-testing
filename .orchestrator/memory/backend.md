...
## Architectural
- [2026-05-30] For the traffic-control MVP from issue #52/#54, the stable contract is REST+polling with four seeded intersections, backend-derived availableActions, and only four manual actions: TAKE_MANUAL_CONTROL, ADVANCE_PHASE, SET_ALL_RED, RESUME_AUTO.
